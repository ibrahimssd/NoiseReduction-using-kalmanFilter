...
clear all; 
close all; 
[x fs]= audioread('C:\Users\Ibrahim\Desktop\Dsp project\Best Day Of My Life 2.mp3'); 
%sound(x);
[xx fss]= audioread('C:\Users\Ibrahim\Desktop\Dsp project\white-noise.mp3');
n = length(xx)
for k = 1 : n
    x(k) = x(k)+ 0.001 * xx(k);
end;
...
sound(orig,fs);
%play this to see the difference ..
%sound(x,fs);